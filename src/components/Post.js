			...
			<Border >
				...
				<Grid is_flex justifyContent="space-between" height="41px"  padding="5px 4px 5px 8px" >
					<Grid is_flex width="auto">
						...
						<Text bold size="14px" margin="6px">{props.user_info.user_name}</Text>
					</Grid>
					<Button width="20px" size="14px" padding="0px" bg="#fff" color="#000"  
				...
				<Div>
					<Text bold size="14px" margin="8px 8px" >{props.user_info.user_name}</Text> 
					<Text bold size="14px" margin="8px 8px" >{props.contents}</Text>
				</Div>
